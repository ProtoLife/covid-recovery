...
t_window=1:15; % the length of the early growth phase
...
DT=1; % temporal resolution o the data in days
...
MAPE=mean(abs((incidence1-data1(:,2))./data1(:,2)))
...
for realization=1:M
    ...
    [P,resnorm,residual]=lsqcurvefit(@plotSimpleGrowth1,z,timevect,yirData,LB,UB,options,I0,flag1,weights);
...
% forecast horizon
forecastingperiod=15; % number of data points ahead
